...
main() {
  ...
  local srcs=(
    ...
    "skills/xbb/scripts/codex-tmux-launch.sh"
    "skills/xbb/scripts/reviewer-spawn-preflight.sh"
    "skills/xbb/scripts/team-guard.sh"
    "skills/xbb/scripts/detect-agent-workspace.sh"
    "skills/xbb/scripts/resolve-team-file.sh"
    "skills/xbb/scripts/xbb-clean.sh"
    "skills/xbb/scripts/context-left.sh"
    "skills/xbb/scripts/tests/context-left.test.sh"
    "skills/xbb/references/codex-launch.md"
    "skills/xbb/references/codex-reviewer-path.md"
  ...
  local dests=(
    ...
    "$skill_link/scripts/codex-tmux-launch.sh"
    "$skill_link/scripts/reviewer-spawn-preflight.sh"
    "$skill_link/scripts/team-guard.sh"
    "$skill_link/scripts/detect-agent-workspace.sh"
    "$skill_link/scripts/resolve-team-file.sh"
    "$skill_link/scripts/xbb-clean.sh"
    "$skill_link/scripts/context-left.sh"
    "$skill_link/scripts/tests/context-left.test.sh"
    "$skill_link/references/codex-launch.md"
    "$skill_link/references/codex-reviewer-path.md"
