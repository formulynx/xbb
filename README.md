...
```sh
curl -fsSL https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.3.0-beta2/install.sh | bash
```
...
one-liner above is pinned to a released tag (`@v0.3.0-beta2`) so installs stay
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.3.0-beta2/install.ps1 | iex
```
...
reinstalls the same `v0.3.0-beta2` copies; it does not fetch newer code. To
upgrade, run the one-liner for the newer release tag (swap `@v0.3.0-beta2` for the
...
https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.3.0-beta2/install.sh | bash -s --
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.3.0-beta2/install.ps1 -OutFile install.ps1
