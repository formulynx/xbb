...
```sh
curl -fsSL https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.1.5/install.sh | bash
```
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.1.5/install.ps1 | iex
```
...
reinstalls the same `v0.1.5` copies — it does not fetch newer code. To
...
https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.1.5/install.sh | bash -s --
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.1.5/install.ps1 -OutFile install.ps1
