...
```sh
curl -fsSL https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.2.0/install.sh | bash
```
...
one-liner above is pinned to a released tag (`@v0.2.0`) so installs stay
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.2.0/install.ps1 | iex
```
...
reinstalls the same `v0.2.0` copies; it does not fetch newer code. To
upgrade, run the one-liner for the newer release tag (swap `@v0.2.0` for the
...
https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.2.0/install.sh | bash -s --
...
```powershell
irm https://cdn.jsdelivr.net/gh/formulynx/xbb@v0.2.0/install.ps1 -OutFile install.ps1
